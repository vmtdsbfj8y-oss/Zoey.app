...
export const es: Resource = {
  ...
  'hero.completeBody': "Zoey terminó la revisión. Sus resultados están listos.",
  ...
  'documents.a11yUploadFor': "Subir {name}",
  ...
  'runzoey.runningSub': "Zoey está leyendo y organizando sus documentos.",
  'runzoey.completeHeadline': "Análisis completo",
  'runzoey.attentionHeadline': "Zoey necesita algo",
  'runzoey.attentionSub': "Zoey no pudo terminar. Sus documentos siguen seguros.",
